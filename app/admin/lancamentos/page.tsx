...
import { ArrowLeft, Plus, X, Save, Download, Upload, Trash2, Edit, Sparkles } from "lucide-react"
...
export default function AdminLancamentosPage() {
  ...
  const handleDeleteProduct = (product: any) => {
    const adminProduct: AdminProduct = {
      ...
      color: product.color,
      image: product.image,
      category: product.categories?.[0] || "Lançamentos",
      subcategory: product.categories?.[1] || "Novo",
    ...
    <div className="min-h-screen bg-black text-white">
      <main className="pt-0">
        <div className="flex">
          ...
          <AdminProductFilters category="Lançamentos" subcategory="Novo" />
          ...
          <div className="flex-1 px-6 py-12">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-4xl font-black bg-gradient-to-r from-white via-blue-400 to-purple-400 bg-clip-text text-transparent flex items-center gap-3">
                    <Sparkles className="h-10 w-10 text-blue-400" />
                    Admin - Lançamentos
                  </h1>
                  <p className="text-gray-300 text-lg">Gerencie os produtos em lançamento</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold px-6 py-3 rounded-xl shadow-lg hover:shadow-blue-500/25 transition-all duration-300 flex items-center"
                >
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 mb-8">
              <h3 className="text-white font-bold text-lg mb-4">📊 Status dos Lançamentos</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4">
                  <div className="text-green-400 font-semibold">Lançamentos</div>
                  <div className="text-white text-2xl font-bold">{lancamentos.length}</div>
                </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Adicionar Lançamento</h2>
              <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ex: Lançamento Gang BoyZ"
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ex: NEW, Lançamento, etc."
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
              ...
              <div className="bg-blue-500/20 border border-blue-500/30 rounded-xl p-4">
                <div className="flex items-center gap-2 text-blue-400">
                  ...
                  <span className="text-sm font-medium">
                    Produto será automaticamente categorizado como: <strong>Lançamentos - Novo</strong>
                  </span>
                </div>
              </div>
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 max-w-md w-full">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6">
                Tem certeza que deseja excluir o lançamento <strong>"{productToDelete.name}"</strong>?
                <br />
