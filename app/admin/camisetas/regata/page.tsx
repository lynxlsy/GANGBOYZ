...
export default function AdminCamisetasRegataPage() {
  ...
  const camisetas = getActiveProductsByCategory("Regata")
  ...
  const handleDeleteProduct = (product: any) => {
    ...
    const adminProduct: AdminProduct = {
      ...
      subcategory: product.categories?.[1] || "Regata",
      label: product.label || "",
    ...
    <div className="min-h-screen bg-black text-white">
      <main className="pt-0">
        <div className="flex">
          ...
          <AdminProductFilters category="Camisetas" subcategory="Regata" />
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div>
                <h1 className="text-4xl font-black bg-gradient-to-r from-white via-red-400 to-blue-400 bg-clip-text text-transparent">
                  Admin - Camisetas Regata
              </h1>
                <p className="text-gray-300 text-lg">Gerencie os produtos da categoria Regata</p>
              </div>
            </div>
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4">
                <div className="text-green-400 font-semibold">Regata</div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Adicionar Produto - Regata</h2>
                <button
              ...
              <div className="bg-blue-500/20 border border-blue-500/30 rounded-xl p-4">
                <div className="flex items-center gap-2 text-blue-400">
                  ...
                  <span className="text-sm font-medium">
                    Produto será automaticamente categorizado como: <strong>Camisetas - Regata</strong>
                  </span>
                </div>
              </div>
      ...
      {editModalOpen && productToEdit && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Editar Produto - Regata</h2>
              <button
                onClick={() => {
                  setEditModalOpen(false)
                  setProductToEdit(null)
