...
import { ArrowLeft, Plus, X, Save, Download, Upload, Trash2, Edit } from "lucide-react"
...
export default function AdminCamisetasTankTopPage() {
  ...
  const camisetas = getActiveProductsByCategory("Tank Top")
  ...
  const handleDeleteProduct = (product: any) => {
    ...
    const adminProduct: AdminProduct = {
      ...
      subcategory: product.categories?.[1] || "Tank Top",
      label: product.label || "",
    ...
    <div className="min-h-screen bg-black text-white">
      <main className="pt-0">
        <div className="flex">
          ...
          <AdminProductFilters category="Camisetas" subcategory="Tank Top" />
              ...
              <Link href="/admin/camisetas">
                <div className="bg-gradient-to-br from-white/10 to-white/20 backdrop-blur-md border border-white/20 rounded-xl px-4 py-2 hover:border-red-400/50 hover:bg-white/20 transition-all duration-500">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-medium">Voltar para Camisetas</span>
                  </div>
            </div>
          </Link>
            <div>
                <h1 className="text-4xl font-black bg-gradient-to-r from-white via-red-400 to-blue-400 bg-clip-text text-transparent">
                  Admin - Camisetas Tank Top
              </h1>
                <p className="text-gray-300 text-lg">Gerencie os produtos da categoria Tank Top</p>
              </div>
            </div>
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4">
                <div className="text-green-400 font-semibold">Tank Top</div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Adicionar Produto - Tank Top</h2>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Nome do Produto */}
                  ...
                  <Input
                    ...
                    placeholder="Ex: Tank Top Gang BoyZ Classic"
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
                    />
                  </div>
              ...
              <div className="bg-blue-500/20 border border-blue-500/30 rounded-xl p-4">
                <div className="flex items-center gap-2 text-blue-400">
                  ...
                  <span className="text-sm font-medium">
                    Produto será automaticamente categorizado como: <strong>Camisetas - Tank Top</strong>
                  </span>
                </div>
              </div>
      ...
      {editModalOpen && productToEdit && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Editar Produto - Tank Top</h2>
              <button
                onClick={() => {
                  setEditModalOpen(false)
                  setProductToEdit(null)
            ...
            <div className="space-y-6">
                  ...
                  <div className="relative">
                    <ProductTemplate
                      product={{
                        ...
                        categories: [productToEdit.category, productToEdit.subcategory].filter(Boolean) as string[],
                        sizes: ["P", "M", "G", "GG"],
                        discountPercentage: productToEdit.originalPrice && productToEdit.originalPrice > productToEdit.price 
                          ? Math.round(((productToEdit.originalPrice - productToEdit.price) / productToEdit.originalPrice) * 100)
                          : undefined,
                        installments: "3x sem juros",
                        brand: "Gang BoyZ",
                        isNew: true,
                        isPromotion: !!(productToEdit.originalPrice && productToEdit.originalPrice > productToEdit.price),
                        description: `${productToEdit.name} - Cor: ${productToEdit.color}`,
                        status: "ativo" as const,
                        stock: 10
                      }}
                      onAddToCart={() => {}}
                    ...
                    {/* Etiqueta de Preview */}
                    {productToEdit.label && productToEdit.labelType && (
                      <div className={`absolute top-2 left-2 px-2 py-1 rounded-md text-xs font-bold text-white ${
                        productToEdit.labelType === 'promocao' ? 'bg-red-500' :
                        productToEdit.labelType === 'esgotado' ? 'bg-gray-600' :
                        'bg-blue-500'
                      }`}>
                        {productToEdit.label}
                      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setProductToEdit(prev => prev ? ({ ...prev, id: e.target.value }) : null)}
                    placeholder="Ex: CT001"
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setProductToEdit(prev => prev ? ({ ...prev, name: e.target.value }) : null)}
                    placeholder="Ex: Tank Top Gang BoyZ Classic"
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setProductToEdit(prev => prev ? ({ ...prev, price: parseFloat(e.target.value) || 0 }) : null)}
                    placeholder="Ex: 44.90"
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setProductToEdit(prev => prev ? ({ ...prev, originalPrice: parseFloat(e.target.value) || undefined }) : null)}
                    placeholder="Ex: 64.90"
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setProductToEdit(prev => prev ? ({ ...prev, color: e.target.value }) : null)}
                    className="w-full bg-gray-800 border border-gray-600 text-white rounded-md px-3 py-2 focus:border-red-500 focus:outline-none"
                  >
                    <option value="">Selecione uma cor</option>
                    <option value="Preto">Preto</option>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        if (file) {
                          const reader = new FileReader()
                          reader.onload = (e) => {
                            setProductToEdit(prev => prev ? ({ ...prev, image: e.target?.result as string }) : null)
                          }
                          reader.readAsDataURL(file)
                        }
                      }}
                      className="bg-gray-800 border-gray-600 text-white"
                    />
                    {productToEdit.image && productToEdit.image !== "/placeholder-default.svg" && (
                      <div className="w-32 h-32 bg-gray-700 rounded-lg overflow-hidden">
                        <img
                ...
                <div>
                  ...
                  <select
                    value={productToEdit.labelType || ""}
                    onChange={(e) => setProductToEdit(prev => prev ? ({ ...prev, labelType: e.target.value as 'promocao' | 'esgotado' | 'personalizada' || undefined }) : null)}
                    className="w-full bg-gray-800 border border-gray-600 text-white rounded-md px-3 py-2 focus:border-red-500 focus:outline-none"
                  >
                    <option value="">Sem etiqueta</option>
                    <option value="promocao">Promoção</option>
                ...
                <div>
                  ...
                  <Input
                    value={productToEdit.label || ""}
                    onChange={(e) => setProductToEdit(prev => prev ? ({ ...prev, label: e.target.value }) : null)}
                    placeholder="Ex: -50%, Esgotado, Novo, etc."
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
                    disabled={!productToEdit.labelType}
                  />
                </div>
              </div>
              ...
              <div className="flex gap-4 pt-6">
                ...
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold"
                >
                  Atualizar Produto
                </Button>
              </div>
