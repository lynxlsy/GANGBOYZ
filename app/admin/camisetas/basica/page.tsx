...
export default function AdminCamisetasBasicaPage() {
  ...
  const camisetas = getActiveProductsByCategory("Básica")
  ...
  const handleDeleteProduct = (product: any) => {
    ...
    const adminProduct: AdminProduct = {
      ...
      subcategory: product.categories?.[1] || "Básica",
      label: product.label || "",
    ...
    <div className="min-h-screen bg-black text-white">
      <main className="pt-0">
        <div className="flex">
          ...
          <AdminProductFilters category="Camisetas" subcategory="Básica" />
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div>
                <h1 className="text-4xl font-black bg-gradient-to-r from-white via-red-400 to-blue-400 bg-clip-text text-transparent">
                  Admin - Camisetas Básica
              </h1>
                <p className="text-gray-300 text-lg">Gerencie os produtos da categoria Básica</p>
              </div>
            </div>
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-4">
                <div className="text-green-400 font-semibold">Básica</div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Adicionar Produto - Básica</h2>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Nome do Produto */}
                  ...
                  <Input
                    ...
                    placeholder="Ex: Camiseta Básica Gang BoyZ"
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-400"
                    />
                  </div>
              ...
              <div className="bg-blue-500/20 border border-blue-500/30 rounded-xl p-4">
                <div className="flex items-center gap-2 text-blue-400">
                  ...
                  <span className="text-sm font-medium">
                    Produto será automaticamente categorizado como: <strong>Camisetas - Básica</strong>
                  </span>
                </div>
              </div>
      ...
      {editModalOpen && productToEdit && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-white">Editar Produto - Básica</h2>
              <button
                onClick={() => {
                  setEditModalOpen(false)
                  setProductToEdit(null)
