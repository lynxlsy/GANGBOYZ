...
export default function CamisetasAdminPage() {
  const subcategories = [
    {
      name: "Regata",
      href: "/admin/camisetas/regata",
      description: "Regatas esportivas e casuais",
      productCount: 8,
      stock: 45
    },
    {
      name: "Tank Top",
      href: "/admin/camisetas/tank-top", 
      description: "Tank tops masculinos e femininos",
      productCount: 12,
      stock: 78
    },
    {
      name: "Polo",
      href: "/admin/camisetas/polo",
    ...
    {
      name: "Básica",
      href: "/admin/camisetas/basica",
      description: "Camisetas básicas e essenciais",
      productCount: 15,
      stock: 120
    }
  ]
    ...
    <div className="min-h-screen bg-black text-white -mt-20 pt-20">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg">
              Escolha uma categoria de camiseta para gerenciar os produtos
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <CategoryStockMonitor category="Camisetas" />
        </div>
