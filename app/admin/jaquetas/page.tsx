...
export default function JaquetasAdminPage() {
  const subcategories = [
    {
      name: "Casual",
      href: "/admin/jaquetas/casual",
      description: "Jaquetas casuais e do dia a dia",
      productCount: 8,
      stock: 45
    },
    {
      name: "Esportiva",
      href: "/admin/jaquetas/esportiva", 
      description: "Jaquetas esportivas e técnicas",
      productCount: 6,
      stock: 32
    },
    {
      name: "Social",
      href: "/admin/jaquetas/social",
      description: "Jaquetas sociais e elegantes",
      productCount: 4,
      stock: 18
    }
  ]
    ...
    <div className="min-h-screen bg-black text-white -mt-20 pt-20">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg">
              Escolha uma categoria de jaqueta para gerenciar os produtos
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <CategoryStockMonitor category="Jaquetas" />
        </div>
