...
export default function CalcasAdminPage() {
  const subcategories = [
    {
      name: "Jeans",
      href: "/admin/calcas/jeans",
      description: "Calças jeans masculinas e femininas",
      productCount: 12,
      stock: 65
    },
    {
      name: "Moletom",
      href: "/admin/calcas/moletom", 
      description: "Calças de moletom confortáveis",
      productCount: 8,
      stock: 42
    },
    {
      name: "Social",
      href: "/admin/calcas/social",
      description: "Calças sociais elegantes",
      productCount: 6,
      stock: 28
    }
  ]
    ...
    <div className="min-h-screen bg-black text-white -mt-20 pt-20">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg">
              Escolha uma categoria de calça para gerenciar os produtos
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <CategoryStockMonitor category="Calças" />
        </div>
