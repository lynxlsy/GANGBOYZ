...
export default function MoletonsAdminPage() {
  const subcategories = [
    {
      name: "Com Capuz",
      href: "/admin/moletons/com-capuz",
      description: "Moletons com capuz e hoodies",
      productCount: 8,
      stock: 45
    },
    {
      name: "Sem Capuz",
      href: "/admin/moletons/sem-capuz", 
      description: "Moletons sem capuz casuais",
      productCount: 6,
      stock: 32
    },
    {
      name: "Zíper",
      href: "/admin/moletons/ziper",
      description: "Moletons com zíper premium",
      productCount: 4,
      stock: 18
    }
  ]
    ...
    <div className="min-h-screen bg-black text-white -mt-20 pt-20">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg">
              Escolha uma categoria de moletom para gerenciar os produtos
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <CategoryStockMonitor category="Moletons" />
        </div>
