    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto p-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-black bg-gradient-to-r from-white via-red-400 to-blue-400 bg-clip-text text-transparent">Gerenciar Coleções</h1>
            <p className="text-gray-300">Crie e edite as coleções exibidas na tela inicial</p>
          </div>
        </div>
