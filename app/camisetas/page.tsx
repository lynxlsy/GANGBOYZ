...
export default function CamisetasPage() {
  const subcategories = [
    { 
      name: "Manga Curta", 
      href: "/camisetas/manga-curta",
      description: "Camisetas clássicas de manga curta",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Manga Longa", 
      href: "/camisetas/manga-longa",
      description: "Camisetas confortáveis de manga longa",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Regata", 
      href: "/camisetas/regata",
      description: "Regatas leves e arejadas",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Tank Top", 
      href: "/camisetas/tank-top",
      description: "Modelos justos e modernos",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Polo", 
      href: "/camisetas/polo",
      description: "Camisetas polo elegantes",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Básica", 
      href: "/camisetas/basica",
      description: "Modelos essenciais do dia a dia",
      image: "/placeholder-category-circle.png"
    }
  ]
        ...
        <div className="flex">
          ...
          <div className="flex-1 py-4 pl-0 md:pl-8">
            ...
            <div className="px-4 md:px-8 py-8">
              <div className="mb-4">
                <h1 className="text-2xl md:text-3xl font-bold text-white">Camisetas</h1>
