...
export default function MoletonsPage() {
  const subcategories = [
    { 
      name: "Com Capuz", 
      href: "/moletons/com-capuz",
      description: "Moletons clássicos com capuz",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Sem Capuz", 
      href: "/moletons/sem-capuz",
      description: "Moletons confortáveis sem capuz",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Zíper", 
      href: "/moletons/ziper",
      description: "Moletons com zíper frontal",
      image: "/placeholder-category-circle.png"
    }
  ]
        ...
        <div className="flex">
          ...
          <div className="flex-1 py-4 pl-0 md:pl-8">
            ...
            <div className="px-4 md:px-8 py-8">
              <div className="mb-4">
                <h1 className="text-2xl md:text-3xl font-bold text-white">Moletons</h1>
