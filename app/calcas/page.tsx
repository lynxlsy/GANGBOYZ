...
export default function CalcasPage() {
  const subcategories = [
    { 
      name: "Jeans", 
      href: "/calcas/jeans",
      description: "Calças jeans clássicas",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Moletom", 
      href: "/calcas/moletom",
      description: "Calças confortáveis de moletom",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Social", 
      href: "/calcas/social",
      description: "Calças para ocasiões especiais",
      image: "/placeholder-category-circle.png"
    }
  ]
        ...
        <div className="flex">
          ...
          <div className="flex-1 py-4 pl-0 md:pl-8">
            ...
            <div className="px-4 md:px-8 py-8">
              <div className="mb-4">
                <h1 className="text-2xl md:text-3xl font-bold text-white">Calças</h1>
