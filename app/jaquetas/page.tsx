...
export default function JaquetasPage() {
  const subcategories = [
    { 
      name: "Casual", 
      href: "/jaquetas/casual",
      description: "Jaquetas para o dia a dia",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Esportiva", 
      href: "/jaquetas/esportiva",
      description: "Jaquetas para atividades físicas",
      image: "/placeholder-category-circle.png"
    },
    { 
      name: "Social", 
      href: "/jaquetas/social",
      description: "Jaquetas para ocasiões especiais",
      image: "/placeholder-category-circle.png"
    }
  ]
        ...
        <div className="flex">
          ...
          <div className="flex-1 py-4 pl-0 md:pl-8">
            ...
            <div className="px-4 md:px-8 py-8">
              <div className="mb-4">
                <h1 className="text-2xl md:text-3xl font-bold text-white">Jaquetas</h1>
