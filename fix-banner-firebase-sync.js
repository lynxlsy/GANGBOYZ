...
console.log('=== Fixing Banner Firebase Synchronization ===');

async function fixBannerFirebaseSync() {
  console.log('Checking banner synchronization with Firebase...');
...
// Run the fix
fixBannerFirebaseSync();

// Also run when the page loads
if (typeof window !== 'undefined') {
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', fixBannerFirebaseSync);
  } else {
    fixBannerFirebaseSync();
  }
}

console.log('\nTo manually run the fix, call: fixBannerFirebaseSync()');

export { fixBannerFirebaseSync };